...
$about_us = $obj->FlyQuery("SELECT * FROM about_us ORDER BY id DESC");
...
<!--                        <div class="article--split-grid" style="padding-left:30px; padding-right: 5px;">
                            <h1 class="article-title"><?php //echo $about_us[0]->page_title; ?></h1>
                            <hr/>
                            <p style="text-align: justify;"><?php //echo html_entity_decode($about_us[0]->page_deatils); ?></p>
                        </div>-->


                        <?php
                            $image = $about_us[0]->image;;
                            if(!empty($image)==1){
                                ?>
                                <div class="article--split__left--container">
                                
                                <div class="article--split__left"  style="background-image: url(cms-admin/upload/<?php echo  $image; ?>); ">
                            ...
                            --><div class="article--split__right--container">
                                <div class="article--split__right">
                                    ...
                                    <div class="article__content  js-post-gallery  cf">
                                        <div class="first-letter" style="font-size:25px;"><?php echo $about_us[0]->page_title;?></div>
                                        <p style="text-align: justify !important"><?php echo html_entity_decode($about_us[0]->page_deatils); ?></p>
                                    </div>
