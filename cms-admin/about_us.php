...
if (isset($_POST['create'])) {
    ...
    if (!empty($page_title)) {
        ...
        $insert = array('page_title' => $page_title, 'image' => $image, 'page_deatils' => $page_deatils, 'date' => date('Y-m-d'), 'status' => 1);
    ...
    if (!empty($page_deatils)) {
        ...
        if (!empty($_FILES['image']['name'])) {
            ...
            $image = $ex_photo;
        }$upd2 = array('page_title' => $page_title, 'image' => $image, 'page_deatils' => $page_deatils, 'date' => date('Y-m-d'), 'status' => 1);
...
if (isset($_GET['edit'])) {
    ?>
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form">
                                <input type="hidden" name="id" value="<?php echo $_GET['edit']; ?>"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='page_title' value='<?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "page_title"); ?>' placeholder='Page Title' class='form-control' />
                                    </div>
    ...
    ?>
                                    ...
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Page Deatils </label>

                                    <div class='col-sm-9'>
                                        <textarea id='editor' name='page_deatils' placeholder='Page Deatils' class='form-control'><?php echo $obj->SelectAllByVal($table, "id", $_GET['edit'], "page_deatils"); ?></textarea>
                                        <script>
...
<?php } else { ?>
                        ...
                        <div class="widget-body"><form enctype='multipart/form-data' class="form-horizontal" method="post" action="" role="form"><div class='form-group'>
                                    ...
                                    <div class='col-sm-9'>
                                        <input type='text' id='form-field-1' name='page_title' placeholder='Page Title' class='form-control' />
                                    </div>
                                </div><div class='form-group'>
                                    <label  for="inputEmail3" class="col-sm-2 control-label"> Image </label>
    ...
    ?>
                                    ...
                                    <div class='col-sm-9'>
                                        <textarea id='editor' name='page_deatils' placeholder='Page Deatils' class='form-control'></textarea>
                                        <script>
                                            $(document).ready(function () {
    // create Editor from textarea HTML element with default set of tools
                                                $("#editor").kendoEditor({resizable: {
