    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="about_us_14"></div>
            </div>
        </div>
        <!-- // About us END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},page_title: {type: "string"},image: {type: "string"},page_deatils: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#about_us_14").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "id", title: "PAGE ID"},{field: "page_title", title: "Page Title"},{field: "image", title: "Image"},
