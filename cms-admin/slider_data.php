            ...
            <script type="text/javascript">
                jQuery(document).ready(function () {
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},slider_name: {type: "string"},image: {type: "string"},slider_top_text: {type: "string"},slider_middle_text: {type: "string"},slider_bottom_text: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    ...
                    jQuery("#slider_3").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "slider_name", title: "Slider Name"},{field: "image", title: "Image"},{field: "slider_top_text", title: "Slider Top Text"},{field: "slider_middle_text", title: "Slider Middle Text"},{field: "slider_bottom_text", title: "Slider Bottom Text"},
