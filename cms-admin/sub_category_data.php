    ...
    <body class="">
        ...
        <div id="content">
          ...
          <div class="innerAll spacing-x2">
                <div class="col-sm-12" id="sub_category_8"></div>
            </div>
        </div>
        <!-- // Sub Category END -->
                    ...
                    var dataSource = new kendo.data.DataSource({
                        ...
                        schema: {
                            ...
                            model: {
                                id: "id",
                                fields: {
                                    id: {nullable: true},category_id: {type: "string"},name: {type: "string"},priority: {type: "string"},
									date: {type: "string"}
                                }
                            }
                        }
                    });
                    jQuery("#sub_category_8").kendoGrid({
                        ...
                        sortable: true,
                        groupable: true,
                        columns: [{field: "category_id", title: "Category ID"},{field: "name", title: "Name"},{field: "priority", title: "Priority"},
