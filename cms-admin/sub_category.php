...
if (isset($_POST['create'])) {
    extract($_POST);
    if (!empty($category_id) && !empty($name) && !empty($priority)) {
        $insert = array('category_id' => $category_id, 'name' => $name, 'priority' => $priority, 'date' => date('Y-m-d'), 'status' => 1);
    ...
    if (!empty($category_id) && !empty($name) && !empty($priority)) {
        ...
        $upd2 = array('category_id' => $category_id, 'name' => $name, 'priority' => $priority, 'date' => date('Y-m-d'), 'status' => 1);
